...
function Header(){
  return(
    <div>
      ...
      <h3>
        This is a comprehensive list of all the basketball teams within the NCAA
      </h3>
...
class Card extends React.Component<Team>{
  render()
  {
        ...
        <div className='col-4'>
          <div className="card" style={{width: "25rem" }}>
            <div className="card-body">
              <h3 className="card-title text-dark" >{team.school}</h3>
              <h4 className="card-text text-dark" >{team.name}</h4>
              <h4 className="card-text text-dark" >{team.city}, {team.state}</h4>
            </div>
          </div>
        </div>
